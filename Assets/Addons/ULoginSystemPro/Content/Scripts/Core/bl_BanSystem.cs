...
public class bl_BanSystem : MonoBehaviour
{
    ...
    [Header("References")]
    public GameObject CheckingBanUI;
        ...
        else
        {
            ...
            else
            {
                if (text.Contains("empty") == true)
                {
                    ...
                    if (Login.GuestButton != null) { Login.GuestButton.interactable = true; }
                }
                else
                {
                    Debug.Log(text);
    ...
    void CheckBan()
    {
        ...
        if (Login.GuestButton != null && !has) { Login.GuestButton.interactable = true; }
    }
